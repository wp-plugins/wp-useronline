...
function useronline_menu() {
	...
	if (function_exists('add_options_page')) {
		add_options_page(__('Useronline'), __('Useronline'), 10, 'useronline/useronline-options.php') ;
	}
}
...
function useronline_header() {
	...
	echo '</script>'."\n";
	echo '<script src="'.get_settings('siteurl').'/wp-content/plugins/useronline/tw-sack.js" type="text/javascript"></script>'."\n";
...
function check_ip($ip) {
   $ip2long = ip2long($ip);
   if(isset($_COOKIE['wordpressuser_'.COOKIEHASH]) && ($ip != 'unknown') && $ip == long2ip($ip2long) && $ip2long !== false) {
...
add_action('admin_head', 'create_useronline_table');
function create_useronline_table() {
	global $wpdb;
	$current = get_settings('active_plugins');
	if($_GET['activate'] == 'true' && in_array('useronline/useronline.php', $current)) {
